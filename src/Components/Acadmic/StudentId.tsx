      ...
      fetch(
        ...
        .then((data) => {
          if (data.success) {
            ...
            QRCode.toDataURL(
              `StudentName: ${studentCard?.name}, Department: ${studentCard?.classs} , RollNumber: ${studentCard?.roll} , Gender: ${studentCard?.gender}, Session: ${studentCard?.session} Phone: ${studentCard?.phone},  `,
              {
                color: {
                  dark: "#335383FF",
                  light: "#EEEEEEFF",
